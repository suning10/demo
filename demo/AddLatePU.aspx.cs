...
namespace demo
{
    public partial class AddLatePU : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    Text = "<th> Location </th> <th> BOL </th> " +
                    "<th> Partner </th><th> ShipTo </th><th> Qty </th><th> Plan P/U DateTime </th><th> Actual Arrive DateTime </th>" +
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cnn.Open();
            SqlCommand cmd = new SqlCommand("[insert_new_p]", cnn);
