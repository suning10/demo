...
namespace demo
{
    public partial class UpdateReasonAPSDel : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if(DropDownList1.SelectedValue != "YTD")
            {
                ...
                string sqlcmd = @"select 
                            ...
                            [Last_Del_Time],[A_ATA_Date_Time],[ATA_Status],iif([ATA_Status]< -30, 'Late','on time') as ArriveCustomer_status,b.reason,b.comment
                            from
                            weekly_tracking a
                            left join
                            failure_tracking b
                            on a.BOL = b.BOL
                            where a.ATA_Status<-30 and b.reason is null
                            and week = @wk;";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string sqlcmd_rc = @"select 
                            ...
                            failure_tracking b
                            on a.BOL = b.BOL
                            where a.[ATA_Status]<-30 and b.reason is null and week = @wk;";
            ...
            else
            {
                ...
                string merge_sql = @" merge failure_tracking  using (select distinct BOL from weekly_tracking where  [ATA_Status]< -30 and [week] = @wk) x
                                on  failure_tracking.BOL =x.BOL
                                when not matched by target
                                then 
                                insert (BOL,ind_field) values (x.BOL,'d') ;
                ...
                cmd.Parameters.AddWithValue("@ind_field", "d");
                ...
                for (int i = 0; i < noOfRows; i++)
                {
                    ...
                    cmd.Parameters["@ind_field"].Value = "d";
                    cmd.ExecuteNonQuery();
        ...
        {
            Server.Transfer("AddLateDel.aspx");
        }
