<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateReasonAPSDel.aspx.cs" Inherits="demo.UpdateReasonAPSDel" %>
...
<h style="text-align: center;"><strong><em><span class="auto-style2">Update Failure Reason Delivery</span></em></strong></h>
        </div>
        ...
        <asp:PlaceHolder ID="PH2" runat="server"></asp:PlaceHolder>
                               ...
                               <div style="text-align: center;">
        <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">Add a new On time Delievery Failure Record</asp:LinkButton>
    </div>
